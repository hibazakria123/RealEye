    ...
    <header className="glass-cream sticky top-0 z-50">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-10">
        <a href="#top" className="flex items-center gap-2 text-ink">
          ...
          <span className="font-serif text-2xl tracking-tight">RealEye</span>
        </a>

        <div className="hidden items-center gap-8 md:flex">
          <a href="#how" className="text-sm font-medium text-ink/75 transition hover:text-ink">
            How It Works
          </a>
          <a href="#models" className="text-sm font-medium text-ink/75 transition hover:text-ink">
            Models
          </a>
          <button
            onClick={onCta}
